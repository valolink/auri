// chartUtils.ts (refactored)
import { useCharts } from '@/services/useCharts'
import { useAppState } from '@/useAppState'

const { updateChart, downloadChart, getChartImage } = useCharts()
const { output, input } = useAppState()
...
export function downloadChartImage() {
  downloadChart('energy', 'bar-chart.png')
}

export function chartImage(): string | undefined {
  return getChartImage('energy')
}
